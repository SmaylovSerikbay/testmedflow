...
export const LogoIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2Zm-8.5 12a1.5 1.5 0 0 1-3 0 1.5 1.5 0 0 1 3 0Zm0-4a1.5 1.5 0 0 1-3 0 1.5 1.5 0 0 1 3 0Zm5 4a1.5 1.5 0 0 1-3 0 1.5 1.5 0 0 1 3 0Zm0-4a1.5 1.5 0 0 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
    <path fillRule="evenodd" d="M12 2a1 1 0 0 1 1 1v2a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1Z" />
    <path fillRule="evenodd" d="M22 12a1 1 0 0 1-1 1h-2a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1Z" />
    <path fillRule="evenodd" d="M2 12a1 1 0 0 1 1-1h2a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1Z" />
    <path fillRule="evenodd" d="M12 22a1 1 0 0 1-1-1v-2a1 1 0 0 1 2 0v2a1 1 0 0 1-1 1Z" />
  </svg>
);

export const CheckShieldIcon = ({ className }: { className?: string }) => (
...
export const UserMdIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
     <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
     <circle cx="9" cy="7" r="4" />
     <path d="M19 8v6" />
...
export const FileSignatureIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M20 19.5v.5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8.5L20 7.5V10" />
    <path d="M18 19l-4.5-4.5" />
    <path d="M13.5 14.5L16 12" />
    <path d="M16 12l5 5-2.5 2.5-5-5" />
  </svg>
);
